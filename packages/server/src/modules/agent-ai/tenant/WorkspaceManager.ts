...
export class WorkspaceManager {
  ...
  constructor(baseStoragePath?: string) {
    // Prioridad: baseStoragePath > AGENTO_STORAGE_PATH > ruta relativa al proyecto
    this.baseStoragePath = baseStoragePath || process.env.AGENTO_STORAGE_PATH || path.join(process.cwd(), 'storage/tenants');
  }
